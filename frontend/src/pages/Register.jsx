...
import { Mic, User as UserIcon, Lock, ArrowRight } from 'lucide-react';
...
function Register() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      {/* Decorative blobs */}
      <div className="absolute top-[-80px] left-[-80px] w-[360px] h-[360px] bg-aqua-200/50 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-[-80px] right-[-80px] w-[360px] h-[360px] bg-aqua-100/60 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-aqua-900 mb-1">Create Account</h1>
          <p className="text-aqua-600 text-sm">Join the Telugu Voice Assistant</p>
        </div>
        ...
        <p className="mt-8 text-center text-gray-400 text-sm">
          ...
          <Link to="/login" className="text-aqua-500 hover:text-aqua-700 font-semibold transition-colors">
            Sign In
          </Link>
        </p>
      </motion.div>
